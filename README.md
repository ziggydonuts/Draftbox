...
A DraftBox is a tool I wished existed: give it a topic, a platform, and a tone, and it drafts three usable captions with hashtags in seconds, styled like pinned index cards you can pick from and copy.
